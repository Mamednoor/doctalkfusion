...
function Medecin() {
  ...
  axios.post('/doctor', {doc_city: city, doc_email: email, doc_firstname: firstname, doc_lastname: lastname,doc_password: password, doc_profession: profession, doc_professionnal_code: professionCode})
